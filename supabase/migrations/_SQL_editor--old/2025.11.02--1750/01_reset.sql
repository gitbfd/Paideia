-- 01_reset.sql — destructive resets of policies/functions/triggers
-- Run ONLY when you intend to reset. Review carefully before executing.
...
-- updated_at trigger
drop trigger if exists trg_lessons_updated_at on public.course_lessons;
...
drop trigger if exists trg_docs_updated_at on public.course_documents;
